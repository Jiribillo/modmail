...
class ConfigManager:
    ...
    public_keys = {
        ...
        "thread_auto_close_response": "Este ticket se ha cerado automaticamente por inactividad.",
        "thread_creation_response": "Algun Mod te contactara pronto, espera mientras tanto.",
        "thread_creation_footer": "Tu mensaje ha sido enviado",
        "thread_self_closable_creation_footer": "Clickea el lock para cerrar el ticket",
        "thread_creation_title": "Ticket Creado",
        "thread_close_footer": "Respnder creara un nuevo ticket",
        "thread_close_title": "Ticket cerrado",
        "thread_close_response": "{closer.mention} Ha cerrado el ticket.",
        "thread_self_close_response": "Acabas de cerrar este ticket.",
        "thread_move_notify": False,
        "thread_move_response": "This thread has been moved.",
        "disabled_new_thread_title": "Not Delivered",
        "disabled_new_thread_response": "No estamos aceptando nuevos tickets.",
        "disabled_new_thread_footer": "Por facor intena despues...",
        "disabled_current_thread_title": "Not Delivered",
        "disabled_current_thread_response": "No estamos aceptando mensajes.",
        "disabled_current_thread_footer": "Por favor intente despues...",
        # moderation
